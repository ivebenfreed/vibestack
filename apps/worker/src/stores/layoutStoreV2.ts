...
export const sectionConfig = {
  ...
  universe: { showSidebar: true, sidebarContent: 'universe' },
  worlds: { showSidebar: true, sidebarContent: 'worlds' },
  entities: { showSidebar: true, sidebarContent: 'entities' },
...
const defaultSidebarPreferences: SidebarPreferences = {
  ...
  universe: { expanded: true },  // Start expanded for better UX
  worlds: { expanded: true },    // Start expanded for better UX
  entities: { expanded: true },  // Start expanded for better UX
  ...
  on: {
    ...
    updateSectionFromRoute: (context, event: { pathname: string }) => {
      ...
      if (pathname.startsWith('/universe')) {
        ...
        newSection = 'entities'
      } else if (pathname.startsWith('/projects') || pathname === '/tasks') {
        newSection = 'projects'
