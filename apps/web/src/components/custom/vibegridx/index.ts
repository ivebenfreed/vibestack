...
export { useVibeGridXRef } from './VibeGridX';
...
/**
 * Creates a complete VibeGridX instance with default configuration
 */
export const createVibeGridX = (entityType: 'task' | 'project' | 'user', config?: Partial<any>) => {
  return {
    entityType,
    config: {
