...
export class InitialMigration1752768020423 implements MigrationInterface {
    name = 'InitialMigration1752768020423'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "tags" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "client_id" uuid, "tag_set_id" uuid NOT NULL, "name" character varying(50) NOT NULL, "slug" character varying(50) NOT NULL, "color" character varying(7) NOT NULL, "icon" character varying(50), "variant" character varying(20) NOT NULL DEFAULT 'solid', "sort_order" integer NOT NULL DEFAULT '0', "parent_id" uuid, "is_active" boolean NOT NULL DEFAULT true, "usage_count" integer NOT NULL DEFAULT '0', "last_used_at" TIMESTAMP WITH TIME ZONE, "metadata" jsonb NOT NULL DEFAULT '{}', CONSTRAINT "UQ_b3aa10c29ea4e61a830362bd25a" UNIQUE ("slug"), CONSTRAINT "PK_e7dc17249a1148a1970748eda99" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "tag_sets" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "client_id" uuid, "name" character varying(100) NOT NULL, "description" text, "category" character varying(50), "is_system" boolean NOT NULL DEFAULT false, "is_active" boolean NOT NULL DEFAULT true, "default_color" character varying(7) NOT NULL DEFAULT '#94a3b8', "display_order" integer NOT NULL DEFAULT '0', "is_exclusive" boolean NOT NULL DEFAULT false, "max_tags" integer, "metadata" jsonb NOT NULL DEFAULT '{}', CONSTRAINT "PK_ae758f64e111877a639b5a4dad2" PRIMARY KEY ("id"))`);
