 ...
 */
let BaseSystemEntity = class BaseSystemEntity {
};
__decorate([
    PrimaryGeneratedColumn('uuid'),
    IsUUID(4, { message: "ID must be a valid UUID" }),
    __metadata("design:type", String)
], BaseSystemEntity.prototype, "id", void 0);
__decorate([
    CreateDateColumn({ type: "timestamptz", name: "created_at" }),
    IsDate({ message: "Created date must be a valid date" }),
    __metadata("design:type", Date)
], BaseSystemEntity.prototype, "createdAt", void 0);
BaseSystemEntity = __decorate([
    TableCategory('system')
], BaseSystemEntity);
export { BaseSystemEntity };
//# sourceMappingURL=BaseSystemEntity.js.map