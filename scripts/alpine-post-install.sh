#!/bin/bash
# Alpine Linux Post-Installation Setup
# Run this INSIDE the Alpine VM after basic installation

set -e

echo "🔧 Alpine Linux Post-Installation Setup"
...
if ! id "developer" &>/dev/null; then
    adduser -D -s /bin/bash -G wheel developer
    echo "developer:developer" | chpasswd
fi

# Add developer to wheel group and configure sudo
...
echo "2. Test SSH: ssh -p 2222 developer@localhost"
