...
export const logControl = {
  ...
  status: () => {
    console.log('🎯 Focus mode:', loggingManager.getFocusMode());
    console.log('🔍 Context filters:', loggingManager.getContextFilters());
  }
};
