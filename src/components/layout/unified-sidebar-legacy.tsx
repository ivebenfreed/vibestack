...
// Remove businessNavigation - will be replaced with 2-level structure
...
function OrganizationView({ orgId, isCollapsed, onBackToUniverse }: {
  ...
  // Get worlds for this organization (placeholder - replace with actual data)
  const orgWorlds = [
    { id: '1', name: 'Personal Workspace', type: 'personal' },
    { id: '2', name: 'Team Projects', type: 'business' },
  ]
...
// Removed legacy EntityNavGroup - functionality moved to OrganizationView
